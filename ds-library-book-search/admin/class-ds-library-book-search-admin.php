...
class Ds_library_book_search_Admin {
    ...
    public function ds_library_book_search_options_page() {
        // admin left menu in admin
        add_menu_page(
                'Book search shortcode', 'Book search shortcode', 'manage_options', 'library_book_search_options', array($this, 'book_search_options_page_html'), 'dashicons-search', 20
        );
    }

    public static function book_search_options_page_html() {
        // Html part for the menu page in admin
