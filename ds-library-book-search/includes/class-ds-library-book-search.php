...
if (!class_exists('Ds_library_book_search')) {
    ...
    class Ds_library_book_search {
        ...
        private function define_public_hooks() {
            ...
            $this->loader->add_filter('the_content', $plugin_public, 'the_content_filter', 20);
            //$this->loader->add_action('pre_get_posts', $plugin_public, 'alter_query',99999);
            // creating Ajax call for WordPress
            add_action('wp_ajax_AjaxFunction', array($this, 'AjaxFunction'));
            add_action('wp_ajax_nopriv_AjaxFunction', array($this, 'AjaxFunction'));
            //add_action('pre_get_posts', array(&$this,'alter_query'),99999);
        }
        ...
        function AjaxFunction() {
            ...
            // print_r($_POST);
            ob_start();
            include plugin_dir_path(__DIR__) . 'public/partials/query-output.php';
            $output = ob_get_clean();
            // return $output;
            // $results = "<h2>hi</h2>";
            // Return the String
        ...
        /**
         * This is to alter our ajax query 
         * @since    0.0.1
          ...
          // echo $query->get_query_var('islbsajax','yes');
          //echo get_query_var('islbsajaxtype','ajax');
          $wpdb->remove_placeholder_escape( $query->request );
          //if ( !$query->is_main_query() )
          return $query;



          //echo $wp_query->get_query_var('lbsajax');
